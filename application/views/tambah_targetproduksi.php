    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <h2>Tambah Target Produksi</h2>
          <br>
          <form action="<?php echo base_url(). 'c_targetproduksi/tambah_data_targetproduksi'; ?>" method="post">
              <div class="col-md-2 mb-3">
                <label for="firstName">Tahun</label>
                <input name="tahun" type="number" class="form-control" id="firstName" placeholder="2012" value="" required>
              ...
              <div class="col-md-2 mb-3">
                ...
                <input name="target_produksi" type="number" class="form-control" id="firstName" placeholder="2215" value="" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
