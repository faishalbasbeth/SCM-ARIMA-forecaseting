    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <br>
          <form action="<?php echo base_url(). 'c_produksi/tambah_data_produksi'; ?>" method="post">
          <div class="col-md-2 mb-3">
              ...
              <div class="col-md-2 mb-3">
                ...
                <input name="produksi" type="number" class="form-control" id="firstName" placeholder="2215" value="" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
