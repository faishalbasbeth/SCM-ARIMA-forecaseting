    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <h2>Verifikasi Tebu</h2>
          <br>
          
          <form action="<?php echo base_url(). 'c_tebu/update_data_statustebu'; ?>" method="post">
            <?php foreach($tebu as $db){
             ?>
              <div class="col-md-2 mb-3">
                <label for="firstName">Berat</label>
                <input name="id_tebu" type="hidden" class="form-control" id="firstName" placeholder="2019" value="<?php echo $db->id_tebu ?>" required>
                <input name="berat" type="number" class="form-control" id="firstName" placeholder="700" value="<?php echo $db->berat ?>" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-3 mb-3">
                <button class="btn btn-sm btn-primary" onclick="return confirm('Apakah Anda Yakin Untuk Memverifikasi Data?')">Simpan</button>
