        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <br>
              <div class="col-md-2 mb-3">
                <a href="<?php echo base_url()."index.php/C_Lahan/tambah_lahan";?>"><button class="btn btn-sm btn-primary">Tambah</button></a>
              </div>
            ...
            <table class="table table-striped table-sm">
              ...
              <tbody>
                <tr>
                  ...
                  <td style="text-align: center;"><?php echo $db->no_surat ?></td>
                  <td style="text-align: center;"><?php echo $db->lahan ?></td>
                  <td style="text-align: center;">
                    <a href="<?php echo base_url('c_lahan/edit_data_lahan/'.$db->id_lahan); ?>" class="btn btn-sm btn-success">Edit</a>
                    <a class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda Yakin Untuk Menghapus Data?')" href="<?php echo base_url('c_lahan/hapus_data_lahan/'.$db->id_lahan); ?>">Hapus</a> 
                  </td>
                </tr>
