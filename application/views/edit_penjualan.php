    ...
    <div class="container-fluid">
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <br>
              <li class="nav-item">
                <a class="nav-link active" href="<?php echo base_url()."index.php/C_Penjualan/penjualan";?>">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <br>
          <form action="<?php echo base_url().'c_penjualan/update_data_penjualan'; ?>" method="post">
          <div class="col-md-2 mb-3">
              ...
              <div class="col-md-2 mb-3">
                <?php foreach($penjualan as $db){
                  ?>
                <label for="firstName">Nama</label>
                <input name="id_penjualan" type="hidden" class="form-control" id="firstName" placeholder="2019" value="<?php echo $db->id_penjualan ?>" required>
              ...
              <div class="col-md-4 mb-3">
                ...
                <input name="alamat" type="text" class="form-control" id="firstName" placeholder="Jl. Mangga no.02 Kepuharjo, Lumajang" value="<?php echo $db->alamat ?>" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-2 mb-3">
                ...
                <input name="tgl" type="date" class="form-control" id="firstName" placeholder="2215" value="<?php echo $db->tgl ?>" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-2 mb-3">
                <label for="firstName">Berat / Ton</label>
                <input name="berat" type="number" class="form-control" id="firstName" placeholder="2215" value="<?php echo $db->berat ?>" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-2 mb-3">
                ...
                <a class="btn btn-sm btn-danger" href="<?php echo base_url()."index.php/C_Penjualan/penjualan";?>">Batal</a>
              </div>
              <br>
              </form>
              <?php } ?>
