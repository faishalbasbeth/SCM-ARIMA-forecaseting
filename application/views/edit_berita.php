      ...
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <br>
              <li class="nav-item">
                <a class="nav-link active" href="<?php echo base_url()."index.php/C_Berita/berita";?>">
                  Berita
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <div class="col-md-2 mb-3">
                ...
                <input name="gambar" type="file" class="form-control" id="firstName" placeholder="Kabupaten, Kecamatan, Desa" value="<?php echo $db->gambar ?>" required>
              ...
              <div class="col-md-5 mb-3">
                ...
                <input name="judul" type="text" class="form-control" id="firstName" placeholder="PTPN XI Berbagi" value="<?php echo $db->judul ?>" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-8 mb-3">
                ...
                <input name="berita" type="text" class="form-control" id="firstName" placeholder="PTPN XI Berbagi" value="<?php echo $db->berita ?>" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
