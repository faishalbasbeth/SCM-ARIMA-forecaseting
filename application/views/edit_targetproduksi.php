    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <h2>Edit Data Target Produksi</h2>
          <br>
          <?php foreach($target_produksi as $db){
                ?>
          <form action="<?php echo base_url(). 'c_targetproduksi/update_data_targetproduksi'; ?>" method="post">
              <div class="col-md-2 mb-3">
                <label for="firstName">Tahun</label>
                <input name="id_targetproduksi" type="hidden" class="form-control" id="firstName" placeholder="2019" value="<?php echo $db->id_targetproduksi ?>" required>
                <input name="tahun" type="number" class="form-control" id="firstName" placeholder="2009" value="<?php echo $db->tahun ?>" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-2 mb-3">
                <label for="firstName">Target Produksi / Ton</label>
                <input name="target_produksi" type="number" class="form-control" id="firstName" placeholder="2215" value="<?php echo $db->target_produksi ?>" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-2 mb-3">
                ...
                <a class="btn btn-sm btn-danger" href="<?php echo base_url()."index.php/C_Targetproduksi/target_produksi";?>">Batal</a>
              </div>
              <br>
              </form>
              <?php } ?>
