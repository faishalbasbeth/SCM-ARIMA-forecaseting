    ...
    <div class="container-fluid">
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <br>
              <li class="nav-item">
                <a class="nav-link active" href="<?php echo base_url()."index.php/C_Lahan/lahan";?>">
                  Lahan
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <h2>Edit Data Lahan</h2>
          <br>
          <?php foreach($lahan as $db){
          ?>
          <form action="<?php echo base_url(). 'c_lahan/update_data_lahan'; ?>" method="post">
          <div class="col-md-4 mb-3">
                <label for="firstName">Lokasi</label>
                <input name="id_lahan" type="hidden" class="form-control" id="firstName" placeholder="Kabupaten, Kecamatan, Desa" value="<?php echo $db->id_lahan ?>" required>
                <input name="lokasi" type="text" class="form-control" id="firstName" placeholder="Kabupaten, Kecamatan, Desa" value="<?php echo $db->lokasi ?>" required>
              ...
              <div class="col-md-2 mb-3">
                ...
                <input name="no_surat" type="number" class="form-control" id="firstName" placeholder="786475678" value="<?php echo $db->no_surat ?>" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-2 mb-3">
                ...
                <input name="lahan" type="number" class="form-control" id="firstName" placeholder="786475678" value="<?php echo $db->lahan ?>" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-2 mb-3">
                ...
                <a class="btn btn-sm btn-danger" href="<?php echo base_url()."index.php/C_Lahan/lahan";?>">Batal</a>
              </div>
              <br>
              </form>
              <?php } ?>
