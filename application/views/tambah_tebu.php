    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <h2>Tambah Tebu</h2>
          <br>
          <form action="<?php echo base_url(). 'c_tebu/tambah_data_tebu'; ?>" method="post">
            ...
            <div class="col-md-3 mb-3">
              ...
              <div class="col-md-2 mb-3">
                ...
                <input name="tgl" type="date" class="form-control" id="firstName" placeholder="2019/01/25" value="" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
