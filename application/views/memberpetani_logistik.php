    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <h2>Data Member Petani</h2>
          <br>
              <p align="right">
                Tahun : 
                <?php
              foreach ($target_limit as $db) {
                ?>
                  <?php echo $db->tahun ?>
                <?php } ?>
                <br>
              ...
              foreach ($target_limit as $db) {
                ...
                Lahan Sendiri : 
                <?php
              foreach ($total_lahanp as $db) {
                ?>
                  <?php echo $db->total_lahanp ?>
                <?php } ?>
                <br>
                Total Lahan Petani :
                <?php
              foreach ($total_lahan as $db) {
                ?>
                  <?php echo $db->total_lahan ?>
                <?php } ?>
              </p>
              <div class="col-md-2 mb-3">
                <a href="<?php echo base_url()."index.php/C_Memberpetani/tambah_memberpetani";?>"><button class="btn btn-sm btn-primary">Tambah</button></a>
              </div>
            ...
            <table class="table table-striped table-sm">
              ...
              <tbody>
                <tr>
                  ...
                  <td style="text-align: center;"><?php echo $db->alamat ?></td>
                  <td style="text-align: center;"><?php echo $db->lokasi ?></td>
                  <td style="text-align: center;"><?php echo $db->nik ?></td>
                  <td style="text-align: center;"><?php echo $db->no_hp ?></td>
                  <td style="text-align: center;"><?php echo $db->lahan ?></td>
                  <td style="text-align: center;">
                    <a href="<?php echo base_url('c_memberpetani/edit_data_memberpetani/'.$db->id_memberpetani); ?>" class="btn btn-sm btn-success">Edit</a>
                    <a class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda Yakin Untuk Menghapus Data?')" href="<?php echo base_url('c_memberpetani/hapus_data_memberpetani/'.$db->id_memberpetani); ?>">Hapus</a> 
                  </td>
                </tr>
