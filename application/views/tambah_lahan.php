    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <h2>Tambah Lahan</h2>
          <br>
          <form action="<?php echo base_url(). 'c_lahan/tambah_data_lahan'; ?>" method="post">
          <div class="col-md-4 mb-3">
                <label for="firstName">Lokasi</label>
                <input name="lokasi" type="text" class="form-control" id="firstName" placeholder="Kabupaten, Kecamatan, Desa" value="" required>
              ...
              <div class="col-md-2 mb-3">
                ...
                <input name="no_surat" type="number" class="form-control" id="firstName" placeholder="67863216723" value="" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-2 mb-3">
                ...
                <input name="lahan" type="number" class="form-control" id="firstName" placeholder="2113" value="" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
