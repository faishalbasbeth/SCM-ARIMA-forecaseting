    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <h2>Tambah Member Petani</h2>
          <br>
          <form action="<?php echo base_url(). 'c_memberpetani/tambah_data_memberpetani'; ?>" method="post">
              <div class="col-md-2 mb-3">
                <label for="firstName">Nama</label>
                <input name="nama" type="text" class="form-control" id="firstName" placeholder="Faishal Basbeth" value="" required>
              ...
              <div class="col-md-4 mb-3">
                ...
                <input name="alamat" type="text" class="form-control" id="firstName" placeholder="Alamat, Kecamatan, Kabupaten" value="" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-4 mb-3">
                ...
                <input name="lokasi" type="text" class="form-control" id="firstName" placeholder="Alamat, Kecamatan, Kabupaten" value="" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-2 mb-3">
                ...
                <input name="nik" type="number" class="form-control" id="firstName" placeholder="1458976390812" value="" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-2 mb-3">
                ...
                <input name="no_hp" type="number" class="form-control" id="firstName" placeholder="081234567890" value="" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
              <div class="col-md-2 mb-3">
                ...
                <input name="lahan" type="number" class="form-control" id="firstName" placeholder="2215" value="" required>
                <div class="invalid-feedback">
                  Valid first name is required.
                </div>
              </div>
