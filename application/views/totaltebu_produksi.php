        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <br>
              <li class="nav-item">
                <a class="nav-link active" href="<?php echo base_url()."index.php/C_Tebu/totaltebu_produksi";?>">
                  <img src="<?php echo base_url() ?>assets/images/rekap.png" alt="tambah surat" height="30px" align="left"/>
                  Total Tebu
                </a>
              </li>
            ...
            <table class="table table-striped table-sm">
              <thead>
                <tr>
                  ...
                  <th style="text-align: center;">Target Berat / Ton</th>
                  <th style="text-align: center;">Target Lahan / Ha</th>
                  <th style="text-align: center;">Total lahan / Ha</th>
                  <th style="text-align: center;">Total Berat Tebu / Ton</th>
                </tr>
              </thead>
              ...
              <tbody>
                <tr>
                  ...
                  <td style="text-align: center;"><?php echo $db->total_lahan ?></td>
