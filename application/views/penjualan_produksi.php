        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <br>
              <div class="col-md-2 mb-3">
                <a href="<?php echo base_url()."index.php/C_Penjualan/tambah_penjualan";?>"><button class="btn btn-sm btn-primary">Tambah</button></a>
              </div>
              ...
              <tbody>
                <tr>
                  ...
                  <td style="text-align: center;">
                    <a href="<?php echo base_url('c_penjualan/edit_data_penjualan/'.$db->id_penjualan); ?>" class="btn btn-sm btn-success">Edit</a>
                    <a class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda Yakin Untuk Menghapus Data?')" href="<?php echo base_url('c_penjualan/hapus_data_penjualan/'.$db->id_penjualan); ?>">Hapus</a> 
                  </td>
                </tr>
