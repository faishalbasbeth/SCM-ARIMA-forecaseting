        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          echo "Tahun : ";
              foreach ($target_produksi as $db) {
                ...
                <?php } ?>
          <?php
          echo "Target Produksi : ";
              foreach ($target_produksi as $db) {
                ?>
                  <?php echo $db->target_produksi ?>
                  <br>
                <?php } ?>
          
              </p>
              <div class="col-md-2 mb-3">
                <a href="<?php echo base_url()."index.php/C_Produksi/tambah_produksi";?>"><button class="btn btn-sm btn-primary">Tambah</button></a>
              </div>
              ...
              <tbody>
                <tr>
                  ...
                  <td style="text-align: center;">
                    <a href="<?php echo base_url('c_produksi/edit_data_produksi/'.$db->id_produksi); ?>" class="btn btn-sm btn-success">Edit</a>
                    <a class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda Yakin Untuk Menghapus Data?')" href="<?php echo base_url('c_produksi/hapus_data_produksi/'.$db->id_produksi); ?>">Hapus</a> 
                  </td>
                </tr>
